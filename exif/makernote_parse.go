...
//
//  1. Buffer origin: every manufacturer parser calls traverse(mn.Value, off, order, nil, false)
...
func parseCanonMakerNote(b []byte, order binary.ByteOrder) *IFD {
	...
	ifd, _, err := traverse(b, 0, order, nil, false)
	if err != nil {
		return nil
	}
	return ifd
...
func parseNikonType3(b []byte, _ binary.ByteOrder) *IFD {
	...
	ifd, _, err := traverse(tiff, ifdOffset, order, nil, false)
	if err != nil {
		return nil
	}
	return ifd
...
func parseNikonType1(b []byte, _ binary.ByteOrder) *IFD {
	...
	ifd, _, err := traverse(b, 0, binary.BigEndian, nil, false)
	if err != nil {
		return nil
	}
	return ifd
...
func parseFujifilmMakerNote(b []byte) *IFD {
	...
	ifd, _, err := traverse(b, ifdOffset, binary.LittleEndian, nil, false)
	if err != nil {
		return nil
	}
	return ifd
...
func parseOlympusMakerNote(b []byte) *IFD {
	...
	ifd, _, err := traverse(b, 12, order, nil, false)
	if err != nil {
		return nil
	}
	return ifd
...
func parsePentaxAOC(b []byte) *IFD {
	ifd, _, err := traverse(b, 6, binary.BigEndian, nil, false)
	if err != nil {
		return nil
	}
	return ifd
...
func parsePanasonicMakerNote(b []byte) *IFD {
	...
	ifd, _, err := traverse(b, 12, binary.LittleEndian, nil, false)
	if err != nil {
		return nil
	}
	return ifd
...
func parseLeicaWithPrefix(b []byte) *IFD {
	ifd, _, err := traverse(b, 8, binary.LittleEndian, nil, false)
	if err != nil {
		return nil
	}
	return ifd
...
func parseLeicaMakerNote(b []byte, parentOrder binary.ByteOrder) *IFD {
	...
	// Type 0: plain IFD at offset 0, parent byte order.
	ifd, _, err := traverse(b, 0, parentOrder, nil, false)
	if err != nil {
		return nil
	}
	return ifd
...
func parseDJIMakerNote(b []byte, parentOrder binary.ByteOrder) *IFD {
	...
	ifd, _, err := traverse(b, 0, binary.LittleEndian, nil, false)
	if err != nil {
		ifd, _, err = traverse(b, 0, parentOrder, nil, false)
		if err != nil {
			return nil
...
func parseSigmaMakerNote(b []byte) *IFD {
	...
	ifd, _, err := traverse(b, 10, binary.LittleEndian, nil, false)
	if err != nil {
		return nil
	}
	return ifd
